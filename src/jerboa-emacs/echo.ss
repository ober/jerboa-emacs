...
(def (test-echo-responses) *test-echo-responses*)
(def (test-echo-responses-set! lst) (set! *test-echo-responses* lst))

;; Global minibuffer history (most recent first)
(def *minibuffer-history* '())
(def (minibuffer-history) *minibuffer-history*)
(def (minibuffer-history-set! lst) (set! *minibuffer-history* lst))
