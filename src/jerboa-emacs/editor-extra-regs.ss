...
(import :std/sugar
        ...
        :jerboa-emacs/editor-cmds-b
        :jerboa-emacs/editor-cmds-c
        (only-in :jerboa-emacs/editor-extra-helpers cmd-flyspell-mode project-current)
        (only-in :jerboa-emacs/editor-extra-tools2 cmd-toggle-header-line)
        (only-in :jerboa-emacs/terminal terminal-buffer?)
        (only-in :jerboa-emacs/editor-extra-web
...
;;; --- Desktop save mode ---
;; *desktop-save-mode* imported from :jerboa-emacs/editor-extra-org
