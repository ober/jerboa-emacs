...
(def (ui-face-set! name . props)
  "Define or update a UI face with properties (string-keyed)."
  (hash-put! *face-definitions* name props))

(def (ui-face-get name)
  "Get UI face properties (string-keyed)."
  (hash-get *face-definitions* name))

;; Define some default faces
(ui-face-set! "default" 'fg: "white" 'bg: "black")
(ui-face-set! "region" 'bg: "blue")
(ui-face-set! "modeline" 'fg: "black" 'bg: "white")
(ui-face-set! "minibuffer" 'fg: "white" 'bg: "black")
(ui-face-set! "comment" 'fg: "gray" 'style: "italic")
(ui-face-set! "string" 'fg: "green")
(ui-face-set! "keyword" 'fg: "cyan" 'style: "bold")
(ui-face-set! "error" 'fg: "red" 'style: "bold")
(ui-face-set! "warning" 'fg: "yellow")
(ui-face-set! "success" 'fg: "green")
