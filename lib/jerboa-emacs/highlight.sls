...
(library (jerboa-emacs highlight)
  ...
  (define *theme-attribute* (rgb->scintilla #xf9 #x91 #x57))
  (define *theme-added*     (rgb->scintilla #x99 #xcc #x99))
  (define *theme-removed*   (rgb->scintilla #xf2 #x77 #x7a))
  (define *theme-heading*   (rgb->scintilla #xcc #x99 #xcc))

  (define style-set!
    (case-lambda
      ((ed id fg) (style-set! ed id fg #f #f))
      ((ed id fg bold?) (style-set! ed id fg bold? #f))
      ((ed id fg bold? italic?)
  ...
  (define (setup-js-highlighting! ed lang)
    (editor-set-lexer-language ed "cpp")
  ...
  (define (setup-c-family-highlighting! ed lang)
    (editor-set-lexer-language ed "cpp")
    (case lang
      ((java)
  ...
  (define (setup-html-highlighting! ed)
  ...
  (define (setup-css-highlighting! ed)
  ...
  (define (setup-json-highlighting! ed)
  ...
  (define (setup-yaml-highlighting! ed)
  ...
  (define (setup-toml-highlighting! ed)
  ...
  (define (setup-markdown-highlighting! ed)
  ...
  (define (setup-bash-highlighting! ed)
  ...
  (define (setup-ruby-highlighting! ed)
  ...
  (define (setup-rust-highlighting! ed)
  ...
  (define (setup-lua-highlighting! ed)
  ...
  (define (setup-sql-highlighting! ed)
  ...
  (define (setup-makefile-highlighting! ed)
  ...
  (define (setup-diff-highlighting! ed)
  ...
  (define (gerbil-file-extension? path)
    (and path
  ...
  (define (detect-language-from-shebang text)
    (and text
  ...
  (define (detect-file-language path)
    (and path
         (let ((ext (path-extension path))
  ...
  (define (enable-code-file-features! ed)
    ;; Fold properties
  ...
  (define *custom-highlighters* (make-hash-table))

  (define (register-custom-highlighter! lang setup-fn)
    (hash-put! *custom-highlighters* lang setup-fn))

  (define (setup-highlighting-for-file! ed filename)
