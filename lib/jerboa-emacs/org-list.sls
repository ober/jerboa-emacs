#!chezscheme
;;; org-list.sls — Org list handling: ordered/unordered, checkboxes, statistics, bullet cycling.
;;;
;;; Ported from gerbil-emacs/org-list.ss
;;; Backend-agnostic (Scintilla API only, no Qt imports).

(library (jerboa-emacs org-list)
  (export
    ;; List item detection
    org-list-item?
    org-count-leading-spaces
