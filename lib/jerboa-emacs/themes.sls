#!chezscheme
;;; themes.sls — Built-in Theme Definitions
;;;
;;; Ported from gerbil-emacs/themes.ss
;;; Each theme defines a complete set of faces for syntax highlighting, UI chrome,
;;; org-mode, and other visual elements.

(library (jerboa-emacs themes)
  (export
    ;; Theme definitions
    theme-dark theme-light
    theme-solarized-dark theme-solarized-light
    theme-monokai
    theme-gruvbox-dark theme-gruvbox-light
  ...
  (def theme-solarized-dark
    '((default . (fg: "#839496" bg: "#002b36"))
      ...
      (font-lock-comment-face . (fg: "#586e75" italic: #t))
      (font-lock-number-face . (fg: "#cb4b16"))
      (font-lock-operator-face . (fg: "#93a1a1"))
      ...
      (split . "#073642")
      (tab-bg . "#002b36") (tab-border . "#073642")
  ...
  (def theme-solarized-light
    '((default . (fg: "#657b83" bg: "#fdf6e3"))
      ...
      (bg . "#fdf6e3") (fg . "#657b83") (selection . "#eee8d5")
      (modeline-bg . "#eee8d5") (modeline-fg . "#586e75")
      (echo-bg . "#eee8d5") (echo-fg . "#586e75")
      (gutter-bg . "#fdf6e3") (gutter-fg . "#93a1a1")
      (split . "#eee8d5")
      (tab-bg . "#fdf6e3") (tab-border . "#eee8d5")
      (tab-active-bg . "#eee8d5") (tab-active-fg . "#002b36")
      (tab-inactive-bg . "#fdf6e3") (tab-inactive-fg . "#93a1a1")))
  ...
  (def theme-monokai
    '((default . (fg: "#f8f8f2" bg: "#272822"))
      (region . (bg: "#49483e"))
      (font-lock-keyword-face . (fg: "#f92672" bold: #t))
      (font-lock-builtin-face . (fg: "#66d9ef"))
      (font-lock-string-face . (fg: "#e6db74"))
      (font-lock-comment-face . (fg: "#75715e" italic: #t))
      (font-lock-number-face . (fg: "#ae81ff"))
      (font-lock-operator-face . (fg: "#f92672"))
      (font-lock-type-face . (fg: "#66d9ef"))
      (font-lock-preprocessor-face . (fg: "#a6e22e"))
      (font-lock-heading-face . (fg: "#66d9ef" bold: #t))
      ...
      (split . "#3e3d32")
      (tab-bg . "#272822") (tab-border . "#3e3d32")
  ...
  (def theme-gruvbox-dark
    '((default . (fg: "#ebdbb2" bg: "#282828"))
      (region . (bg: "#504945"))
      (font-lock-keyword-face . (fg: "#fb4934" bold: #t))
      (font-lock-builtin-face . (fg: "#83a598"))
      (font-lock-string-face . (fg: "#b8bb26"))
      (font-lock-comment-face . (fg: "#928374" italic: #t))
      (font-lock-number-face . (fg: "#d3869b"))
      (font-lock-operator-face . (fg: "#fe8019"))
      (font-lock-type-face . (fg: "#fabd2f"))
      (font-lock-preprocessor-face . (fg: "#8ec07c"))
      (font-lock-heading-face . (fg: "#83a598" bold: #t))
      ...
      (bg . "#282828") (fg . "#ebdbb2") (selection . "#504945")
      (modeline-bg . "#3c3836") (modeline-fg . "#ebdbb2")
      (echo-bg . "#3c3836") (echo-fg . "#ebdbb2")
      (gutter-bg . "#282828") (gutter-fg . "#928374")
      (split . "#3c3836")
      (tab-bg . "#282828") (tab-border . "#3c3836")
      (tab-active-bg . "#504945") (tab-active-fg . "#ebdbb2")
      (tab-inactive-bg . "#282828") (tab-inactive-fg . "#928374")))
  ...
  (def theme-gruvbox-light
    '((default . (fg: "#3c3836" bg: "#fbf1c7"))
      ...
      (bg . "#fbf1c7") (fg . "#3c3836") (selection . "#ebdbb2")
      (modeline-bg . "#ebdbb2") (modeline-fg . "#3c3836")
      (echo-bg . "#ebdbb2") (echo-fg . "#3c3836")
      (gutter-bg . "#fbf1c7") (gutter-fg . "#928374")
      (split . "#ebdbb2")
      (tab-bg . "#fbf1c7") (tab-border . "#ebdbb2")
      (tab-active-bg . "#ebdbb2") (tab-active-fg . "#3c3836")
      (tab-inactive-bg . "#fbf1c7") (tab-inactive-fg . "#928374")))
  ...
  (def theme-dracula
    '((default . (fg: "#f8f8f2" bg: "#282a36"))
      (region . (bg: "#44475a"))
      (font-lock-keyword-face . (fg: "#ff79c6" bold: #t))
      (font-lock-builtin-face . (fg: "#8be9fd"))
      (font-lock-string-face . (fg: "#f1fa8c"))
      (font-lock-comment-face . (fg: "#6272a4" italic: #t))
      (font-lock-number-face . (fg: "#bd93f9"))
      (font-lock-operator-face . (fg: "#ff79c6"))
      (font-lock-type-face . (fg: "#50fa7b"))
      (font-lock-preprocessor-face . (fg: "#ffb86c"))
      (font-lock-heading-face . (fg: "#8be9fd" bold: #t))
      ...
      (modeline-bg . "#44475a") (modeline-fg . "#f8f8f2")
      (echo-bg . "#44475a") (echo-fg . "#f8f8f2")
      (gutter-bg . "#282a36") (gutter-fg . "#6272a4")
      (split . "#44475a")
      (tab-bg . "#282a36") (tab-border . "#44475a")
      (tab-active-bg . "#44475a") (tab-active-fg . "#f8f8f2")
      (tab-inactive-bg . "#282a36") (tab-inactive-fg . "#6272a4")))
  ...
  (def theme-nord
    '((default . (fg: "#d8dee9" bg: "#2e3440"))
      ...
      (bg . "#2e3440") (fg . "#d8dee9") (selection . "#434c5e")
      (modeline-bg . "#3b4252") (modeline-fg . "#d8dee9")
      (echo-bg . "#3b4252") (echo-fg . "#d8dee9")
      (gutter-bg . "#2e3440") (gutter-fg . "#616e88")
      (split . "#3b4252")
      (tab-bg . "#2e3440") (tab-border . "#3b4252")
      (tab-active-bg . "#434c5e") (tab-active-fg . "#d8dee9")
      (tab-inactive-bg . "#2e3440") (tab-inactive-fg . "#616e88")))
  ...
  (def theme-zenburn
    '((default . (fg: "#dcdccc" bg: "#3f3f3f"))
      ...
      (bg . "#3f3f3f") (fg . "#dcdccc") (selection . "#5f5f5f")
      (modeline-bg . "#2b2b2b") (modeline-fg . "#dcdccc")
      (echo-bg . "#2b2b2b") (echo-fg . "#dcdccc")
      (gutter-bg . "#3f3f3f") (gutter-fg . "#7f7f7f")
      (split . "#2b2b2b")
      (tab-bg . "#3f3f3f") (tab-border . "#2b2b2b")
      (tab-active-bg . "#5f5f5f") (tab-active-fg . "#dcdccc")
      (tab-inactive-bg . "#3f3f3f") (tab-inactive-fg . "#7f7f7f")))
