...
;;; Source: src/jerboa-emacs/qt/commands-parity3b.ss

(library (jerboa-emacs qt commands-parity3b)
  (export cmd-tetris *snake-active* *snake-game* SNAKE-W
   SNAKE-H SNAKE-RIGHT SNAKE-DOWN SNAKE-LEFT SNAKE-UP
   SNAKE-STYLE-BORDER SNAKE-STYLE-BODY SNAKE-STYLE-HEAD
   SNAKE-STYLE-FOOD SNAKE-STYLE-STATUS SCI_STYLESETFORE-SNAKE
   SCI_STARTSTYLING-SNAKE SCI_SETSTYLING-SNAKE char-utf8-len
   snake-dir->head-char snake-pick-food snake-build-text
   snake-apply-styles! snake-redraw! snake-tick!
   snake-handle-key! cmd-snake cmd-hanoi cmd-life cmd-dunnet
   *doctor-responses* cmd-doctor cmd-proced cmd-proced-filter
   cmd-proced-send-signal cmd-calculator cmd-calculator-inline
   cmd-calc-eval-region *calc-stack* calc-show-stack!
   cmd-calc-push cmd-calc-pop cmd-calc-dup cmd-calc-swap
   calc-binary-op! calc-unary-op! cmd-calc-add cmd-calc-sub
   cmd-calc-mul cmd-calc-div cmd-calc-mod cmd-calc-pow
   cmd-calc-neg cmd-calc-abs cmd-calc-sqrt cmd-calc-log
   cmd-calc-exp cmd-calc-sin cmd-calc-cos cmd-calc-tan
   cmd-calc-floor cmd-calc-ceiling cmd-calc-round
   cmd-calc-clear cmd-server-start cmd-server-edit
   cmd-server-force-delete cmd-eww-forward cmd-eww-download
   cmd-eww-copy-page-url cmd-eww-search-web *qt-gdb-process*
   qt-gdb-send! cmd-gdb cmd-gud-break cmd-gud-cont cmd-gud-next
   cmd-gud-step cmd-gud-remove cmd-mc-add-next cmd-mc-add-all
   cmd-mc-mark-next-like-this cmd-mc-mark-previous-like-this
   cmd-mc-mark-all-like-this cmd-mc-skip-and-add-next
   cmd-mc-cursors-on-lines cmd-scheme-send-buffer
   cmd-scheme-send-region cmd-inferior-lisp
   cmd-duplicate-and-comment cmd-smart-backspace
   cmd-smart-open-line-above cmd-smart-open-line-below
   cmd-fold-this cmd-fold-this-all cmd-fold-toggle-at-point
   cmd-wrap-region-with cmd-unwrap-region cmd-vc-dir
   cmd-vc-print-log cmd-vc-register cmd-vc-stash
   cmd-vc-stash-pop cmd-treemacs-find-file
   cmd-project-tree-toggle-node cmd-rotate-frame
   cmd-window-save-layout cmd-window-restore-layout cmd-uptime
   cmd-world-clock cmd-memory-usage cmd-generate-password
   cmd-epoch-to-date cmd-detect-encoding
   cmd-open-containing-folder cmd-display-prefix
   cmd-display-prefix-help cmd-push-mark-command
   cmd-exchange-dot-and-mark cmd-move-to-window-center
   cmd-set-goal-column cmd-isearch-occur
   cmd-isearch-toggle-case-fold cmd-isearch-toggle-regexp
   cmd-copy-as-formatted cmd-copy-rectangle-to-clipboard
   cmd-canonically-space-region cmd-format-region
   csv-split-line cmd-csv-align-columns cmd-json-sort-keys
   cmd-jq-filter cmd-html-encode-region cmd-html-decode-region
   cmd-encode-hex-string cmd-decode-hex-string
   cmd-increment-hex-at-point cmd-titlecase-region
   cmd-reverse-region-chars cmd-reverse-words-in-region
   cmd-sort-words-in-line cmd-sort-paragraphs
   cmd-goto-random-line cmd-open-line-below cmd-open-recent-dir
   ...
   *re-builder-indicator* cmd-re-builder cmd-regex-builder
   cmd-find-file-with-warnings cmd-quick-run
   cmd-flyspell-auto-correct-word cmd-flyspell-goto-next-error
   cmd-helpful-callable cmd-helpful-key cmd-helpful-variable
   cmd-tags-search cmd-tags-query-replace
   cmd-tramp-cleanup-connections
   cmd-tramp-cleanup-all-connections cmd-tramp-version
   cmd-apply-macro-to-region-lines cmd-edit-kbd-macro
   cmd-execute-named-macro cmd-kmacro-add-counter
   cmd-kmacro-insert-counter cmd-kmacro-set-counter
   cmd-kmacro-set-format cmd-insert-mode-line
   cmd-insert-random-line cmd-insert-register-content
   cmd-insert-scratch-message cmd-markdown-insert-header
   cmd-selection-info cmd-rename-symbol *qt-killed-buffers*
   *qt-max-killed-buffers* qt-remember-killed-buffer!
   cmd-reopen-killed-buffer cmd-save-persistent-scratch
   cmd-load-persistent-scratch cmd-complete-word-from-buffer
   cmd-add-dir-local-variable cmd-add-file-local-variable
   cmd-org-roam-node-find cmd-org-roam-node-insert
   *qt-perspectives* *qt-current-perspective* cmd-persp-switch
   cmd-persp-add-buffer cmd-persp-remove-buffer
   *qt-emms-player-process* *qt-emms-current-file*
   *qt-emms-paused* *qt-emms-playlist* *qt-emms-playlist-idx*
   qt-emms-find-player qt-emms-play-track! cmd-emms
   cmd-emms-play-file cmd-emms-next cmd-emms-previous
   cmd-emms-pause cmd-emms-stop cmd-eat cmd-vundo
   cmd-undo-fu-only-undo cmd-undo-fu-only-redo
   cmd-unexpand-abbrev cmd-sp-forward-slurp-sexp
   cmd-sp-backward-slurp-sexp cmd-sp-forward-barf-sexp
   cmd-sp-backward-barf-sexp qt-register-parity4-commands!)
  (import
   ...
   (only (jerboa-emacs ipc) *ipc-server-file*) (jerboa core)
   (jerboa runtime))
  (def (cmd-tetris app)
       "Display a Tetris game board."
       (let* ([ed (current-qt-editor app)]
              [fr (app-state-frame app)]
              [buf (or (buffer-by-name "*Tetris*")
                       (qt-buffer-create! "*Tetris*" ed #f))])
         (qt-buffer-attach! ed buf)
         (qt-edit-window-buffer-set! (qt-current-window fr) buf)
         (qt-plain-text-edit-set-text!
           ed
           (string-append "TETRIS\n\n" "  +----------+\n" "  |          |\n"
             "  |          |\n" "  |          |\n" "  |          |\n"
             "  |          |\n" "  |        |\n" "  |        |\n"
             "  |      |\n" "  |      |\n" "  |    |\n"
             "  +----------+\n\n" "Score: 0\n\n"
  ...
  (define *snake-active*--cell (vector #f))
  (define *snake-game*--cell (vector #f))
  (def SNAKE-W 30)
  (def SNAKE-H 14)
  (def SNAKE-RIGHT 0)
  (def SNAKE-DOWN 1)
  (def SNAKE-LEFT 2)
  (def SNAKE-UP 3)
  (def SNAKE-STYLE-BORDER 1)
  (def SNAKE-STYLE-BODY 2)
  (def SNAKE-STYLE-HEAD 3)
  (def SNAKE-STYLE-FOOD 4)
  (def SNAKE-STYLE-STATUS 5)
  ...
  (def (snake-build-text state)
       ...
       (let* ([snake (vector-ref state 0)]
              ...
              [status (cond
                        [over?
                         (format
                           "GAME OVER  Score:~a  Length:~a  [q or C-g to quit]"
                           score
                           (length snake))]
                        [else
                         (format
                           "Score:~a  Length:~a  [arrows:move  p:pause  q:quit]"
                           score
                           (length snake))])])
         (string-append top (apply string-append rows) bot "\n"
           status "\n")))
  (def (snake-apply-styles! ed text)
       "Walk TEXT and apply Scintilla color styles for border/body/head/food chars."
       (sci-send
         ed
         SCI_STYLESETFORE-SNAKE
         SNAKE-STYLE-BORDER
         6710886)
       (sci-send
         ed
  ...
  (def (snake-tick! app)
       ...
       (when (and *snake-game*
                  (not (vector-ref *snake-game* 4))
                  (not (vector-ref *snake-game* 5)))
               ...
               (begin
                 ...
                 (when fed?
                   (vector-set!
                     state
                     2
                     (snake-pick-food (vector-ref state 0) W H))
  ...
  (def (cmd-snake app)
       ...
       (let* ([ed (current-qt-editor app)]
              ...
              [state (vector init-snake SNAKE-RIGHT
                       (snake-pick-food init-snake W H) 0 #f #f)])
  ...
  (def (cmd-hanoi app)
       ...
       (let* ([n-str (qt-echo-read-string
                       app
                       "Number of disks (1-8): ")]
              [n (if (and n-str (not (string-empty? n-str)))
                     (string->number n-str)
                     4)])
         (when (and n (> n 0) (<= n 8))
           (let* ([moves (list)]
                  [_ (let hanoi ([n n] [from "A"] [to "C"] [aux "B"])
                       (when (> n 0)
                         ...
                         (set! moves
                           (cons
                             (string-append "Move disk " (number->string n)
                               " from " from " to " to)
                             moves))
                         (hanoi (- n 1) aux to from)))]
                  [text (string-append "Towers of Hanoi (" (number->string n)
                          " disks)\n\n" "Moves required: "
                          (number->string (length moves)) "\n\n"
                          (string-join (reverse moves) "\n") "\n")]
                  [ed (current-qt-editor app)]
                  [fr (app-state-frame app)]
                  [buf (or (buffer-by-name "*Hanoi*")
                           (qt-buffer-create! "*Hanoi*" ed #f))])
             (qt-buffer-attach! ed buf)
             (qt-edit-window-buffer-set! (qt-current-window fr) buf)
             (qt-plain-text-edit-set-text! ed text)
             (sci-send ed SCI_SETREADONLY 1)))))
                              ...
                              (let cp ([i 0])
                                (when (< i (* width height))
                                  (vector-set!
                                    grid
                                    i
                                    (vector-ref new-grid i))
                                  (cp (+ i 1)))))
                            (gen-loop (+ gen 1))))))])
         (let* ([ed (current-qt-editor app)]
                [fr (app-state-frame app)]
                [buf (or (buffer-by-name "*Life*")
                         (qt-buffer-create! "*Life*" ed #f))])
           (qt-buffer-attach! ed buf)
           (qt-edit-window-buffer-set! (qt-current-window fr) buf)
           (qt-plain-text-edit-set-text! ed text)
  ...
  (def (cmd-dunnet app)
       ...
       (let* ([ed (current-qt-editor app)]
              [fr (app-state-frame app)]
              [buf (or (buffer-by-name "*Dunnet*")
                       (qt-buffer-create! "*Dunnet*" ed #f))])
         (qt-buffer-attach! ed buf)
         (qt-edit-window-buffer-set! (qt-current-window fr) buf)
         (qt-plain-text-edit-set-text!
           ed
           (string-append "Dead End\n\n"
  ...
  (define *doctor-responses*--cell
    (vector
      '("Tell me more about that." "How does that make you feel?" "Why do you say that?"
         "Can you elaborate on that?"
         "That's interesting. Please continue."
         "I see. And what else?" "How long have you felt this way?"
  ...
  (def (cmd-doctor app)
       ...
       (let* ([ed (current-qt-editor app)]
              [fr (app-state-frame app)]
              [buf (or (buffer-by-name "*Doctor*")
                       (qt-buffer-create! "*Doctor*" ed #f))])
         (qt-buffer-attach! ed buf)
         (qt-edit-window-buffer-set! (qt-current-window fr) buf)
         (qt-plain-text-edit-set-text!
           ed
         ...
         (with-catch
           ...
           (lambda ()
             (let* ([proc (open-process
                            (list 'path: "ps" 'arguments:
                              '("aux" "--sort=-pcpu") 'stdout-redirection:
                              #t))]
       ...
       (let* ([echo (app-state-echo app)]
         ...
         (when (and pattern (> (string-length pattern) 0))
           (let* ([lines (string-split text #\newline)]
                  ...
                  [body (if (pair? lines) (cdr lines) (list))]
                  [filtered (filter
                              (lambda (line)
             ...
             (echo-message!
               echo
               (string-append "Showing " (number->string (length filtered))
  ...
  (def (cmd-proced-send-signal app)
       ...
       (let* ([echo (app-state-echo app)]
         ...
         (if (not pid-str)
             ...
             (let ([signal (qt-echo-read-with-narrowing
                             app
                             "Signal: "
                             '("TERM" "KILL" "HUP" "INT" "STOP" "CONT"
                                "USR1" "USR2"))])
  ...
  (def (cmd-calculator-inline app) (cmd-calculator app))
         ...
         (if (= start end)
             ...
             (let ([text (sci-get-text-range ed start end)])
               (with-catch
                 ...
                 (lambda ()
                   (let* ([result (eval
                                    (call-with-input-string text read))]
                          [result-str (with-output-to-string
                                        (lambda () (display result)))])
                     (echo-message!
                       echo
                       (string-append "= " result-str)))))))))
  (define *calc-stack*--cell (vector (list)))
           ...
           (with-catch
             ...
             (lambda ()
               (let ([val (string->number expr)])
                 (if val
                     (begin
                       (set! *calc-stack* (cons val *calc-stack*))
                       (calc-show-stack! app))
  ...
  (def (cmd-calc-swap app)
       ...
       (if (< (length *calc-stack*) 2)
           (echo-message!
             (app-state-echo app)
             "Need 2+ values to swap")
           (let ([a (car *calc-stack*)] [b (cadr *calc-stack*)])
  ...
  (def (calc-binary-op! app label op-fn)
       ...
       (let* ([echo (app-state-echo app)] [st *calc-stack*])
         (if (< (length st) 2)
             (echo-error!
               echo
               (string-append "calc-" label ": need 2 values"))
             (let* ([b (car st)]
                    [a (cadr st)]
                    [rest (cddr st)]
                    [result (with-catch
               ...
               (if result
                   (begin
                     (set! *calc-stack* (cons result rest))
                     (calc-show-stack! app))
                   (echo-error!
                     echo
                     (string-append
  ...
  (def (calc-unary-op! app label op-fn)
       ...
       (let* ([echo (app-state-echo app)] [st *calc-stack*])
         (if (null? st)
             (echo-error!
               echo
               (string-append "calc-" label ": stack empty"))
             (let* ([a (car st)]
                    [rest (cdr st)]
                    [result (with-catch
                              (lambda (e) #f)
               ...
               (if result
                   ...
                   (echo-error!
                     echo
                     (string-append "calc-" label ": error")))))))
  (def (cmd-calc-add app)
       "Pop 2, push sum."
       (calc-binary-op! app "+" +))
  (def (cmd-calc-sub app)
       "Pop 2, push difference."
       (calc-binary-op! app "-" -))
  (def (cmd-calc-mul app)
       "Pop 2, push product."
       (calc-binary-op! app "*" *))
  (def (cmd-calc-div app)
       "Pop 2, push quotient."
       (calc-binary-op! app "/" /))
  (def (cmd-calc-mod app)
       "Pop 2, push modulo."
       (calc-binary-op! app "mod" modulo))
  (def (cmd-calc-pow app)
       "Pop 2, push a^b."
       (calc-binary-op! app "pow" expt))
  (def (cmd-calc-neg app)
       "Pop 1, push negated."
       (calc-unary-op! app "neg" (lambda (a) (- a))))
  (def (cmd-calc-abs app)
       "Pop 1, push absolute value."
       (calc-unary-op! app "abs" abs))
  (def (cmd-calc-sqrt app)
       "Pop 1, push square root."
       (calc-unary-op! app "sqrt" sqrt))
  (def (cmd-calc-log app)
       "Pop 1, push natural log."
       (calc-unary-op! app "log" log))
  (def (cmd-calc-exp app)
       "Pop 1, push e^a."
       (calc-unary-op! app "exp" exp))
  (def (cmd-calc-sin app)
       "Pop 1, push sin (radians)."
       (calc-unary-op! app "sin" sin))
  (def (cmd-calc-cos app)
       "Pop 1, push cos (radians)."
       (calc-unary-op! app "cos" cos))
  (def (cmd-calc-tan app)
       "Pop 1, push tan (radians)."
       (calc-unary-op! app "tan" tan))
  (def (cmd-calc-floor app)
       "Pop 1, push floor."
       (calc-unary-op! app "floor" floor))
  (def (cmd-calc-ceiling app)
       "Pop 1, push ceiling."
       (calc-unary-op! app "ceiling" ceiling))
  (def (cmd-calc-round app)
       "Pop 1, push round."
       (calc-unary-op! app "round" round))
  (def (cmd-calc-clear app)
       "Clear the entire calculator stack."
       (set! *calc-stack* (list))
       (echo-message!
         (app-state-echo app)
         "Stack: (empty — cleared)"))
         ...
         (when (and query (> (string-length query) 0))
           (let* ([encoded (string-map
             ...
             (let ([cmd (find-command 'eww)])
               (if cmd
                   (begin (set! *eww-current-url* url) (cmd app))
                   (echo-message!
                     echo
                     (string-append "Search URL: " url))))))))
  (define *qt-gdb-process*--cell (vector #f))
               ...
               (cond
                 ...
                 [(string-prefix? "(gdb)" line)
                  ...
                  (let ([text (string-join (reverse lines) "\n")])
                    (when (> (string-length text) 0)
                      (echo-message! (app-state-echo app) text)))]
                 [(> count 200) (input-port-timeout-set! proc +inf.0)]
                 [else (loop (cons line lines) (+ count 1))]))))))
  (def (cmd-gdb app)
             ...
             (lambda ()
               ...
               (let* ([proc (open-process
                              (list 'path: "gdb" 'arguments:
                                (list "-q" "--interpreter=mi2" program)
                 ...
                 (qt-plain-text-edit-set-text!
                   ed
                   (string-append "GDB: " program "\n\n"))
                 (qt-gdb-send! "" app)
                 (echo-message!
                   echo
                   (string-append "GDB started for " program))))))))
         ...
         (if *qt-gdb-process*
             (begin
               ...
               (echo-message!
                 ...
                 (string-append
                   "Breakpoint at "
                   (or (and path (path-strip-directory path)) "?")
                   ":"
                   (number->string line))))
             (echo-message!
               (app-state-echo app)
               (string-append
                 "GDB not running. Breakpoint noted at line "
                 (number->string line))))))
  (def (cmd-gud-cont app)
       "Continue execution in GDB."
       (if *qt-gdb-process*
           (begin
             (qt-gdb-send! "-exec-continue" app)
  ...
  (def (cmd-gud-remove app)
       ...
       (if *qt-gdb-process*
           (begin
             (qt-gdb-send! "-break-delete" app)
             (echo-message!
               (app-state-echo app)
               "GUD: breakpoints cleared"))
           (echo-message! (app-state-echo app) "GDB not running")))
  (def (cmd-mc-add-next app)
       (let ([ed (current-qt-editor app)])
         ...
         (echo-message!
           (app-state-echo app)
           "Added next occurrence")))
  (def (cmd-mc-add-all app)
       (let ([ed (current-qt-editor app)])
         (sci-send ed SCI_MULTIPLESELECTADDEACH 0)
         (echo-message!
           (app-state-echo app)
           "Selected all occurrences")))
  (def (cmd-mc-mark-next-like-this app) (cmd-mc-add-next app))
             ...
             (let* ([text (qt-plain-text-edit-text ed)]
               ...
               (if (not found)
                   ...
                   (begin
                     ...
                     (echo-message!
                       (app-state-echo app)
                       "Added previous occurrence")))))))
  (def (cmd-mc-mark-all-like-this app) (cmd-mc-add-all app))
  (def (cmd-mc-skip-and-add-next app)
       (let ([ed (current-qt-editor app)])
         (sci-send ed SCI_MULTIPLESELECTADDNEXT 0)
         (echo-message!
           (app-state-echo app)
           "Skipped and added next")))
  ...
  (def (cmd-fold-toggle-at-point app) (cmd-fold-this app))
           ...
           (let* ([ed (current-qt-editor app)]
             ...
             (if (= start end)
                 ...
                 (let ([text (sci-get-text-range ed start end)])
                   ...
                   (echo-message!
                     echo
                     (string-append "Wrapped with " wrapper))))))))
  ...
  (def (cmd-vc-dir app) (execute-command! app 'magit-status))
  ...
  (def (cmd-vc-stash app)
       ...
       (let* ([buf (current-qt-buffer app)]
         ...
         (with-catch
           ...
           (lambda ()
             (let* ([proc (open-process
                            (list 'path: "/usr/bin/git" 'arguments: '("stash")
                              'directory: dir 'stdout-redirection: #t
                              'stderr-redirection: #t))]
  ...
  (def (cmd-project-tree-toggle-node app)
       (echo-message!
         (app-state-echo app)
         "Use RET in project tree to toggle"))
  (def (cmd-rotate-frame app)
       (echo-message!
         (app-state-echo app)
         "Use C-x o to cycle windows"))
              ...
              [pw (let loop ([i 0] [acc '()])
                    (if (= i 16)
                        ...
                        (loop
                          (+ i 1)
                          (cons
                            (string-ref chars (random-integer len))
                            acc))))])
         (echo-message!
           (app-state-echo app)
           (string-append "Password: " pw))))
       ...
       (let* ([fr (app-state-frame app)]
         ...
         (if (not path)
             ...
             (with-catch
               ...
               (lambda ()
                 (let ([proc (open-process
                               (list 'path: "file" 'arguments:
                                 (list "-bi" path) 'stdout-redirection:
                                 #t))])
                   (let ([out (read-line proc)])
                     (close-port proc)
                     (echo-message!
                       echo
                       (or out "Unknown encoding")))))))))
         ...
         (if (not path)
             ...
             (let ([dir (path-directory path)])
               (with-catch
                 ...
                 (lambda ()
                   (open-process
                     (list 'path: "xdg-open" 'arguments: (list dir)))
                   (echo-message!
                     echo
                     (string-append "Opened: " dir))))))))
  (def (cmd-display-prefix app)
       (let ([arg (app-state-prefix-arg app)])
         (echo-message!
           (app-state-echo app)
           (if arg
               (string-append "Prefix: " (number->string arg))
               "No prefix arg"))))
  ...
  (def (cmd-isearch-occur app) (execute-command! app 'occur))
       ...
       (let* ([ed (current-qt-editor app)]
         ...
         (if (null? rows)
             ...
             (let* ([num-cols (apply max (map length rows))]
                    [widths (let loop ([col 0] [acc (list)])
                              (if (>= col num-cols)
                                  (reverse acc)
                                  (loop
                                    (+ col 1)
  ...
  (def (cmd-increment-hex-at-point app)
       ...
       (let* ([ed (current-qt-editor app)]
              ...
              [line-start (sci-send
                            ...
                            (sci-send ed SCI_LINEFROMPOSITION pos))]
              [line-end (sci-send
                          ed
                   ...
                   (let hex-loop ([j (+ i 2)] [digits ""])
                     (if (and (< j (string-length line-text))
                         ...
                         (hex-loop
                           ...
                           (string-append
                             digits
                             (string (string-ref line-text j))))
                         (if (string-empty? digits)
                             (loop (+ i 1))
                             (let* ([val (string->number digits 16)]
                                    [new-val (+ val 1)]
                                    [new-hex (string-append
                                               "0x"
                                               (number->string
                                                 new-val
                                                 16))]
                                    [full-text (qt-plain-text-edit-text
                                                 ed)]
                               ...
                               (qt-plain-text-edit-set-cursor-position!
                                 ed
                                 (+ abs-start (string-length new-hex)))
                               (echo-message!
                                 echo
                                 (string-append
                                   "0x"
  ...
  (def (cmd-titlecase-region app)
       (let* ([ed (current-qt-editor app)]
         ...
         (if (= start end)
             (echo-message! (app-state-echo app) "No region selected")
             (let* ([text (sci-get-text-range ed start end)]
                    [titled (let loop ([chars (string->list text)]
                                       [cap? #t]
                                       [acc '()])
                              (if (null? chars)
                                  (list->string (reverse acc))
  ...
  (def (cmd-sort-paragraphs app)
       ...
       (let* ([ed (current-qt-editor app)]
              [text (qt-plain-text-edit-text ed)]
              [paras (let loop ([s text] [start 0] [acc (list)])
  ...
  (def (cmd-what-tab-width app)
       (echo-message!
         ...
         (string-append
           "Tab width: "
           (number->string
             (sci-send (current-qt-editor app) SCI_GETTABWIDTH)))))
  (def (cmd-cd app)
       (let* ([echo (app-state-echo app)]
  ...
  (def (cmd-eshell-here app) (execute-command! app 'eshell))
  (def (cmd-suspend-emacs app)
       (echo-message!
         (app-state-echo app)
         "Suspend not supported in Qt mode"))
  ...
  (def (cmd-set-buffer-mode app)
       (echo-message!
         (app-state-echo app)
         "Use M-x <language>-mode to set mode"))
  (def (cmd-set-face-attribute app)
       (echo-message!
         (app-state-echo app)
         "Use M-x load-theme to change appearance"))
  ...
  (define *re-builder-indicator*--cell (vector 30))
       ...
       (let ([pattern (qt-echo-read-string app "Regex: ")])
         (when (and pattern (> (string-length pattern) 0))
           (let* ([fr (app-state-frame app)]
             ...
             (sci-send ed SCI_INDICSETSTYLE *re-builder-indicator* 7)
             (sci-send ed SCI_INDICSETFORE *re-builder-indicator* 65280)
             (sci-send ed 2523 *re-builder-indicator* 80)
             ...
             (let loop ([pos 0] [count 0])
               ...
               (let ([found (sci-send/string
                 ...
                 (if (< found 0)
                     (echo-message!
                       (app-state-echo app)
                       (string-append "Regex: " (number->string count)
                         " matches for /" pattern "/"))
                     (let ([mstart (sci-send ed SCI_GETTARGETSTART)]
                       ...
                       (if (or (<= mend pos) (= mstart mend))
                           (echo-message!
                             (app-state-echo app)
                             (string-append "Regex: "
                               (number->string count) " matches for /"
                               pattern "/"))
                           (begin
                             (sci-send
                               ed
                               SCI_SETINDICATORCURRENT
                               *re-builder-indicator*)
                             (sci-send
                               ed
                               ...
                               (- mend mstart))
                             (loop mend (+ count 1))))))))))))
  (def (cmd-regex-builder app) (cmd-re-builder app))
  (def (cmd-find-file-with-warnings app)
       (execute-command! app 'find-file))
  (def (cmd-quick-run app) (execute-command! app 'compile))
  ...
  (def (cmd-rename-symbol app)
       (execute-command! app 'query-replace))
  (define *qt-killed-buffers*--cell (vector '()))
  (define *qt-max-killed-buffers*--cell (vector 20))
             ...
             (when (and val (> (string-length val) 0))
               (let ([line (string-append var " = " val "\n")])
                 (with-catch
                   ...
                   (lambda ()
                     (with-output-to-file
                       (list 'path: config-path 'append: #t)
                       (lambda () (display line)))
                     (echo-message!
                       (app-state-echo app)
                       (string-append "Added to " config-path ": " var
                         " = " val))))))))))
           ...
           (let ([val (qt-echo-read-string
             ...
             (when (and val (> (string-length val) 0))
               (let* ([text (qt-plain-text-edit-text ed)]
                      ...
                      [first-line (if first-nl
                                      (substring text 0 first-nl)
                                      text)])
                 (if (and (string-prefix? ";; -*- " first-line)
                          (string-suffix? "-*-" first-line))
                     (let* ([existing (substring
                                        first-line
                                        6
           ...
           (let ([notes-dir (string-append (getenv "HOME") "/notes/")])
             (with-exception-catcher
               (lambda (e)
                 (echo-error!
                   echo
                   "Notes directory not found — create ~/notes/"))
               (lambda ()
                 (let* ([proc (open-process
                                (list 'path: "grep" 'arguments:
                                  (list "-rl" query notes-dir)
                                  'stdin-redirection: #f
                                  'stdout-redirection: #t
         ...
         (when (and target (not (string-empty? target)))
           (let ([pos (sci-send ed SCI_GETCURRENTPOS)])
             (sci-send/string
               ...
               SCI_INSERTTEXT
               pos
               (string-append "[[roam:" target "]]"))))))
  (define *qt-perspectives*--cell (vector (make-hash-table)))
  (define *qt-current-perspective*--cell (vector "default"))
           ...
           (let* ([existing (or (hash-get
             ...
             (echo-message!
               ...
               (string-append
                 ...
                 " from "
                 *qt-current-perspective*))))))
  (define *qt-emms-player-process*--cell (vector #f))
  (define *qt-emms-current-file*--cell (vector #f))
  (define *qt-emms-paused*--cell (vector #f))
  (define *qt-emms-playlist*--cell (vector (list)))
  (define *qt-emms-playlist-idx*--cell (vector 0))
  ...
  (def (qt-emms-play-track! app file)
       ...
       (let ([echo (app-state-echo app)]
         ...
         (if (not player)
             (echo-error!
               echo
               "No media player found (mpv, mplayer, or ffplay)")
             (begin
               ...
               (set! *qt-emms-player-process*
                 (open-process
                   (list 'path: player 'arguments: (list "--quiet" file)
       ...
       (let ([echo (app-state-echo app)])
         (if *qt-emms-current-file*
             (echo-message!
               ...
               (string-append
                 "Now playing: "
                 (path-strip-directory *qt-emms-current-file*)
                 (if *qt-emms-paused* " [PAUSED]" "")))
             (echo-message!
               echo
               "No track playing. Use emms-play-file to start."))))
                   ...
                   (begin
                     (when *qt-emms-player-process*
                       (with-exception-catcher
                         (lambda (e) #f)
                         (lambda ()
                           (close-port *qt-emms-player-process*))))
                     (set! *qt-emms-player-process*
                       (open-process
                         (list 'path: player 'arguments: (list "--quiet" file)
                           'stdin-redirection: #f 'stdout-redirection: #f
                     ...
                     (unless (member file *qt-emms-playlist*)
                       (set! *qt-emms-playlist*
                         (append *qt-emms-playlist* (list file))))
  ...
  (def (cmd-emms-next app)
       ...
       (let ([echo (app-state-echo app)])
         (if (null? *qt-emms-playlist*)
             (echo-message!
               echo
               "Playlist is empty. Use emms-play-file to add tracks.")
             (begin
               (set! *qt-emms-playlist-idx*
                 (modulo
                   (+ *qt-emms-playlist-idx* 1)
                   (length *qt-emms-playlist*)))
               (qt-emms-play-track!
                 app
                 (list-ref *qt-emms-playlist* *qt-emms-playlist-idx*))))))
       ...
       (let ([echo (app-state-echo app)])
         (if (not *qt-emms-player-process*)
             ...
             (begin
               ...
               (echo-message!
                 echo
                 (if *qt-emms-paused* "Paused" "Resumed"))))))
  ...
  (def (cmd-eat app) (execute-command! app 'terminal))
  (def (cmd-vundo app)
  ...
  (def (qt-register-parity4-commands!)
       ...
       (qt-register-parity3-stubs!) (qt-register-parity3-aliases!)
       (for-each
         (lambda (pair) (register-command! (car pair) (cdr pair)))
         (list (cons 'tetris cmd-tetris) (cons 'snake cmd-snake)
          (cons 'hanoi cmd-hanoi) (cons 'life cmd-life)
          (cons 'dunnet cmd-dunnet) (cons 'doctor cmd-doctor)
          ...
          (cons 'calc-pop cmd-calc-pop) (cons 'calc-dup cmd-calc-dup)
          (cons 'calc-swap cmd-calc-swap)
          (cons 'calc-add cmd-calc-add) (cons 'calc-sub cmd-calc-sub)
          (cons 'calc-mul cmd-calc-mul) (cons 'calc-div cmd-calc-div)
          (cons 'calc-mod cmd-calc-mod) (cons 'calc-pow cmd-calc-pow)
          (cons 'calc-neg cmd-calc-neg) (cons 'calc-abs cmd-calc-abs)
          (cons 'calc-sqrt cmd-calc-sqrt)
          (cons 'calc-log cmd-calc-log) (cons 'calc-exp cmd-calc-exp)
          (cons 'calc-sin cmd-calc-sin) (cons 'calc-cos cmd-calc-cos)
          ...
          (cons 'gdb cmd-gdb) (cons 'gud-break cmd-gud-break)
          (cons 'gud-cont cmd-gud-cont) (cons 'gud-next cmd-gud-next)
          ...
          (cons 'what-tab-width cmd-what-tab-width) (cons 'cd cmd-cd)
          ...
          (cons 'emms-stop cmd-emms-stop) (cons 'eat cmd-eat)
  ...
  (define-syntax *snake-active*
    (identifier-syntax
      [id (vector-ref *snake-active*--cell 0)]
      [(set! id val) (vector-set! *snake-active*--cell 0 val)]))
  (define-syntax *snake-game*
    (identifier-syntax
      [id (vector-ref *snake-game*--cell 0)]
      [(set! id val) (vector-set! *snake-game*--cell 0 val)]))
  (define-syntax *doctor-responses*
    (identifier-syntax
      [id (vector-ref *doctor-responses*--cell 0)]
      [(set! id val) (vector-set!
                       *doctor-responses*--cell
                       0
                       val)]))
  (define-syntax *calc-stack*
    (identifier-syntax
      [id (vector-ref *calc-stack*--cell 0)]
      [(set! id val) (vector-set! *calc-stack*--cell 0 val)]))
  (define-syntax *qt-gdb-process*
    (identifier-syntax
      [id (vector-ref *qt-gdb-process*--cell 0)]
      [(set! id val) (vector-set! *qt-gdb-process*--cell 0 val)]))
  (define-syntax *re-builder-indicator*
    (identifier-syntax
      [id (vector-ref *re-builder-indicator*--cell 0)]
      [(set! id val) (vector-set!
                       *re-builder-indicator*--cell
                       0
                       val)]))
  (define-syntax *qt-killed-buffers*
    (identifier-syntax
      [id (vector-ref *qt-killed-buffers*--cell 0)]
      [(set! id val) (vector-set!
                       *qt-killed-buffers*--cell
                       0
                       val)]))
  (define-syntax *qt-max-killed-buffers*
    (identifier-syntax
      [id (vector-ref *qt-max-killed-buffers*--cell 0)]
      [(set! id val) (vector-set!
                       *qt-max-killed-buffers*--cell
                       0
                       val)]))
  (define-syntax *qt-perspectives*
    (identifier-syntax
      [id (vector-ref *qt-perspectives*--cell 0)]
      [(set! id val) (vector-set!
                       *qt-perspectives*--cell
                       0
                       val)]))
  (define-syntax *qt-current-perspective*
    (identifier-syntax
      [id (vector-ref *qt-current-perspective*--cell 0)]
      [(set! id val) (vector-set!
                       *qt-current-perspective*--cell
                       0
                       val)]))
  (define-syntax *qt-emms-player-process*
    (identifier-syntax
      [id (vector-ref *qt-emms-player-process*--cell 0)]
      [(set! id val) (vector-set!
                       *qt-emms-player-process*--cell
                       0
                       val)]))
  (define-syntax *qt-emms-current-file*
    (identifier-syntax
      [id (vector-ref *qt-emms-current-file*--cell 0)]
      [(set! id val) (vector-set!
                       *qt-emms-current-file*--cell
                       0
                       val)]))
  (define-syntax *qt-emms-paused*
    (identifier-syntax
      [id (vector-ref *qt-emms-paused*--cell 0)]
      [(set! id val) (vector-set! *qt-emms-paused*--cell 0 val)]))
  (define-syntax *qt-emms-playlist*
    (identifier-syntax
      [id (vector-ref *qt-emms-playlist*--cell 0)]
      [(set! id val) (vector-set!
                       *qt-emms-playlist*--cell
                       0
                       val)]))
  (define-syntax *qt-emms-playlist-idx*
    (identifier-syntax
      [id (vector-ref *qt-emms-playlist-idx*--cell 0)]
      [(set! id val) (vector-set!
                       *qt-emms-playlist-idx*--cell
                       0
                       val)])))
